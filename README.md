...
## 👨‍💻 Linguagens: 
[![My Skills](https://skillicons.dev/icons?i=java,kotlin,python,javascript,cs,php,flutter,node,springboot)](https://skillicons.dev)

## 🗄️ Bancos de Dados: 
[![My Skills](https://skillicons.dev/icons?i=mysql,mongo,postgres,mysql,firebird,sqlserver,oracle,aws)](https://skillicons.dev)
## ⚙️ Ferramentas:
